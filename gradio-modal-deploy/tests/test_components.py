...
def test_modal_deploy_button_creation():
...
def test_modal_theme_creation():
    """Test ModalTheme creation."""
    theme = ModalTheme()
    assert theme is not None


def test_validate_app_file_nonexistent():
...
def test_validate_app_file_wrong_extension():
...
def test_validate_gradio_app(sample_gradio_app):
