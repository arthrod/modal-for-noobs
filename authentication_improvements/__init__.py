...
def target_help() -> str:
    help_string = (
        "The modal-for-noobs plugin integrates Modal "
        ...
        "    * MODAL_WORKSPACE\n\n"
        "Basic usage:\n\n"
        "    modal-for-noobs deployments <command> -t modal\n\n"
        "For more details and examples, see the README at "
        "https://github.com/garretthoffman/modal-for-noobs/blob/main/README.md\n\n"
    )
    return help_string
    ...
    if flavor is not None and flavor != "python_function":
        raise MlflowException(
            message=(
                ...
                f"flavor is currently supported by modal-for-noobs."
            ),
