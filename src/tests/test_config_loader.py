...
class TestConfigLoader:
    ...
    def test_load_base_packages_success(self):
        ...
        test_config = {"minimum": ["package1", "package2"], "optimized": ["package1", "package2", "package3"]}
    ...
    def test_load_deployment_examples_success(self):
        ...
        test_config = {"examples": {"test_app": {"name": "Test Application", "path": "path/to/test.py", "mode": "minimum"}}}
