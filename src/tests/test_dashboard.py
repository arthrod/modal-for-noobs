...
def test_launch_dashboard_with_custom_options():
    ...
    with (
        patch("modal_for_noobs.dashboard.ModalDashboard") as mock_dashboard_class,
        ...
        with patch.object(mock_interface, "launch") as mock_launch:
            ...
            mock_launch.assert_called_once_with(server_name="0.0.0.0", server_port=8080, share=True, quiet=True)
